class systematics(object):
    def __init__(self,mode,photon_ana=False,mjj_syst=False):
        ...
        self.systematicsListDown=["MET_SoftTrk_ResoParaDown", "MET_SoftTrk_ResoPerpDown", 'JET_JER_EffectiveNP_1__1down', 'JET_JER_EffectiveNP_2__1down', 'JET_JER_EffectiveNP_3__1down', 'JET_JER_EffectiveNP_4__1down', 'JET_JER_EffectiveNP_5__1down', 'JET_JER_EffectiveNP_6__1down', 'JET_JER_EffectiveNP_7__1down', #'JET_JER_EffectiveNP_7restTerm__1down',
        ...
        if self.photon_ana:
            self.removeList=['TAUS_','JET_MassRes_','JET_Rtrk_','JET_Comb_','FT_EFF_','eleANTISFEL_EFF_Iso_','MJ','vvUnc','PH_EFF_TRIGGER_Uncertainty'] #'VBF_qqH_','ggF_gg2H_','nloEWKWeight_'
        ...
        if mode == "All":
            ...
            self.systematicsList = ['Nominal',
                                    ...
                                    #'JET_JER_EffectiveNP_7restTerm__1up',
                                       ...
                                       'JET_fJvtEfficiency__1down','JET_fJvtEfficiency__1up','JET_JvtEfficiency__1down','JET_JvtEfficiency__1up',
                                    'JET_JER_DataVsMC_AFII__1down','JET_JER_DataVsMC_AFII__1up','JET_RelativeNonClosure_AFII__1up','JET_RelativeNonClosure_AFII__1down','JET_PunchThrough_AFII__1down','JET_PunchThrough_AFII__1up', # for af2
