...
arg_group.add_argument("--PhotonSkimSyst", dest="PhotonSkimSyst", action="store_true",default=False,help="Run PhotonSkimSyst when set to true")
...
arg_group.add_argument("--doVjetMjjRW", dest='doVjetMjjRW', action="store_true", default=False, help="apply Mjj V+jets theory reweighing ")
...
athAlgSeq += CfgMgr.VBFAnalysisAlg("VBFAnalysisAlg",
                                   ...
                                   PhotonSkimSyst = args.PhotonSkimSyst,
                                   ExtraVars=True,
